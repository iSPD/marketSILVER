...
# MANIFEST_PATH=$(realpath .)/transcriptions/oldSpeech2/grapheme_character_spelling
# MANIFEST_PATH=$(realpath .)/transcriptions/oldSpeech3/grapheme_character_spelling
MANIFEST_PATH=$(realpath .)/transcriptions/speakKoreanCon/grapheme_character_spelling
...
# CHECKPOINT_PATH=$(realpath .)/save_checkpoint/pretrain/english_pretrain/checkpoint_best.pt  ## it is dummy, please modify it
# CHECKPOINT_PATH=$(realpath .)/save_checkpoint/finetuneDo/ksponspeech/multi_model/checkpoint_best.pt  ## it is dummy, please modify it
# CHECKPOINT_PATH=$(realpath .)/save_checkpoint/finetune/oldSpeech2/multi_model/checkpoint_best.pt  ## it is dummy, please modify it
# CHECKPOINT_PATH=$(realpath .)/save_checkpoint/finetune/oldSpeech2/multi_model/checkpoint_14_80000.pt  ## it is dummy, please modify it
CHECKPOINT_PATH=$(realpath .)/save_checkpoint/finetune/speakAll1/multi_model/checkpoint_last.pt  ## it is dummy, please modify it
...
for SUBSET in dev; do
    ...
    # --labels ltr \
    CUDA_VISIBLE_DEVICES=1 python inference/beam_search.py ${MANIFEST_PATH} \
       --task ${TASK} \
